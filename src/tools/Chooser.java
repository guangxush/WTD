...
/**
 * @ClassName:     Chooser.java
 * @Description:   TODO(用一句话描述该文件做什么) 
 * 
 * @author          wangxiaoyu
 * @version         V1.0  
 * @Date           2017年12月19日 上午9:45:33 
 */
...
private static final long serialVersionUID = -5384012731547358720L;
    ...
    private void showPanel(Component owner) {
        ...
        java.awt.Point show = new Point(0, showDate.getHeight());
    ...
    private class DayLabel extends JLabel implements java.util.Comparator<DayLabel>, java.awt.event.MouseListener, java.awt.event.MouseMotionListener {
        ...
        @Override
        public void mouseReleased(MouseEvent e) {
            java.awt.Point p = SwingUtilities.convertPoint(this, e.getPoint(), bodyPanel);
    ...
    private class LabelManager {
        ...
        public void setSelect(java.awt.Point p, boolean b) {
            //如果是拖动,则要优化一下,以提高效率  
            if (b) {
